...
import {getStatusBarHeight} from "./bar/StatusBarHeightUitl";
  ...
  render() {
          ...
          <Animated.View
            style={{
              ...
              marginTop: fullScreenAnim.interpolate({
                inputRange: [0, 1],
                outputRange: [0, screenHeight * -1 - NAVBAR_HEIGHT],
              }),
            }}
          >
            <GridContainer
    ...
    return (
      <View style={[styles.container, {
        paddingTop: gridContainer ? (NAVBAR_HEIGHT + getStatusBarHeight()) : 0,
      }, style]}>
        {gridContainer}
        {fullScreenContainer}
